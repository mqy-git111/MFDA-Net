...
def elastic_transform(image, alpha, sigma, alpha_affine, random_state=None):
    ...
    # cuda_handle = Handle(array_image.shape, RGB=False, mode='reflect')
    ...
    #
    # # out = Image.fromarray(output[0].transpose(1, 2, 0), mode=array_image.mode)
    # # out = Image.fromarray(output[0].transpose(1, 2, 0). \
    # #                       astype(array_image.dtype), mode=array_image.mode)
    # return output
