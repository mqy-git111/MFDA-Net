...
class DataGenerator(keras.utils.Sequence):
    ...
    def __getitem__(self, index):
        ...
        img_v, img_a, mask, edge = self.__data_generation(list_IDs_temp)
        # edge_gt = mask_edge(mask)
        return [img_v, img_a], [mask, edge]
    ...
    def __data_generation(self, list_IDs_temp):
        ...
        edge = np.empty((self.batch_size, *self.img_size, 1))
